...
import uz.gita.exam5bookapp.databinding.ItemBookBiggerBinding
import uz.gita.exam5bookapp.databinding.ItemBookBinding


class BookListMainAdapter : ListAdapter<BookData, BookListMainAdapter.BooksViewHolder>(BookDiff) {
    ...
    inner class BooksViewHolder(private val binding: ItemBookBiggerBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BooksViewHolder =
        BooksViewHolder(ItemBookBiggerBinding.inflate(LayoutInflater.from(parent.context), parent, false))
