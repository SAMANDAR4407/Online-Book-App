...
fun BookResponse.toBookEntity() = BookEntity(id, title, author, genre, about, page, rate, year, bookUrl, coverUrl, reference)
fun BookResponse.toBookData() = BookData(id, title, author, genre, about, page, rate, year, bookUrl, coverUrl, reference)
...
fun BookData.toBookEntity() = BookEntity(id, title, author, genre, about, page, rate, year, bookUrl, coverUrl, reference, lastPage, saved)
...
fun BookEntity.toBookResponse() = BookResponse(id, title, author, genre, about, page, rate, year, bookUrl, coverUrl, reference)
